      ...
      <div className="sidebar-wrapper" id="sidebar-wrapper">
        <div className="logo-wrapper">
          <Link to={`/dashboard/home`}>
            <img className="img-fluid for-light" src="../../assets/images/logo/logo.png" alt="" />
            <img className="img-fluid for-dark" src="../../assets/images/logo/logo_dark.png" alt="" />
          </Link>
        ...
        <div className="logo-icon-wrapper">
          <Link to={`/dashboard/default/home`}><img className="img-fluid" src="../../assets/images/logo/logo-icon.png" alt="" /></Link>
        </div>
